...
{KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, FUNC(2), FUNC(4), FUNC(3), KC_RGUI, KC_RALT, FUNC(12), FUNC(13)}},
...
const uint16_t PROGMEM fn_actions[] = {
    [0]  = ACTION_LAYER_TAP_KEY(4, KC_N),	      // FN0  - Media Keys
    [1]  = ACTION_LAYER_TAP_KEY(3, KC_B),	      // FN1  - Mouse and Arrows
