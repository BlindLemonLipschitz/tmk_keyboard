...
{KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, FUNC(2), FUNC(4), FUNC(3), KC_RGUI, KC_RALT, FUNC(5), KC_KC_TRNS}},
...
{KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, S(KC_EQ), S(KC_LBRC), S(KC_RBRC), S(KC_BSLS)}, 
...
{KC_TRNS, FN5, FN6, FN7, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
